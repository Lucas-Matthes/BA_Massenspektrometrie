...
if __name__ == "__main__":
    ...
    from src.MasterPipeline import MasterPipeline  # falls nötig nochmal importieren

    pipeline = MasterPipeline(
        eval_cc=True, eval_rf=True, eval_db=True,
        n_estimators=5000, count=5, bin_size=0.05
    )
    pipeline.run()
